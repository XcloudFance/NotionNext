...
const BLOG = {
  AUTHOR: 'XCloudFance', // 作者
  BIO: '1st year of software engineering student | University of Malaya', // 作者简介
  LINK: 'https://tangly1024.com', // 网站地址
  KEYWORDS: 'Notion, 博客, XCloudFance', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'ca59b945421d4d908eb0331accc8423d', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'xcloudfance@gmail.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/xcloudfance',
  CONTACT_TELEGRAM: 'https://t.me/xcloudfance',
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Lancelot\'s Blog', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '一个用NotionNext搭建的博客，随手分享一下简单的技术', // 站点描述，被notion中的页面描述覆盖
